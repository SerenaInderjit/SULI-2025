...
# Future idea for generalization 
#  Have user input class with other parameters to customize the signal instead of EpicsMotor


class CustomMotor(Device):
    pos_lookup = Cpt(DynamicLookup, "")
    motor = FCpt(EpicsMotor, "{prefix}Mtr")
